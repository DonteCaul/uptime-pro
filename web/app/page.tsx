...
const FEATURES = [
  ...
  },
  {
    icon: PlaneTakeoff,
    title: "Auto-Ingest",
    desc: "Upload your Dekunu CSVs and get full jump data — altitude, speed, glide ratios, and more, all parsed automatically.",
  },
  {
    icon: Map,
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-4 py-20 sm:py-28">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            ...
            analysis, and community leaderboards. Upload your files and
            get full jump data.
          </p>
